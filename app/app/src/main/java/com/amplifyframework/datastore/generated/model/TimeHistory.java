...
public final class TimeHistory implements Model {
  public static final QueryField ID = field("TimeHistory", "id");
  public static final QueryField USER_ID = field("TimeHistory", "UserID");
  public static final QueryField DATE = field("TimeHistory", "Date");
  public static final QueryField CHECK_IN = field("TimeHistory", "CheckIn");
  public static final QueryField DESCRIPTION = field("TimeHistory", "Description");
